...
exports.PROJECT_EXCLUDED_COMMANDS = ["getUserProjects", "addHost", "rebootHost", "addImage", "addUser", "lookupHost", 
    "listHostResources", "listVMsForHost", "customCmd", "changeUserRole", "liveMigrate", "listVMImages","listVlans","listRules",
    "listIps","listVmHosts","createFirewall","firewallvm","addIpToHost"]
